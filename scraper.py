...
if GITHUB_PAT:
    print(f"INFO: GitHub PAT found (length: {len(GITHUB_PAT)}).")
    HEADERS['Authorization'] = f'token {GITHUB_PAT}'
else:
    print("CRITICAL: GH_PAT secret is NOT set. Dynamic source discovery will be skipped.")
    ...
    try:
        ...
        for query in GITHUB_SEARCH_QUERIES:
            ...
            try:
                ...
                print(f"WARNING: GitHub API error during search for query '{query}'. This might be a rate limit issue. Error: {e}")
                continue
